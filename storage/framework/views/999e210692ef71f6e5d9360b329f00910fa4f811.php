...
<main role="main">
        ...
        <div class="user-settings">
            <h1 style="margin-left:16%">MY PROFILE</h1>
            <div class="col-md-2 hidden-xs offset-2">
                    <img style="position:relative;" src="/resources/assets/img/avatar.jpg" class="img-responsive img-thumbnail ">
            ...
            <div class="col-md-9 personal-info">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input  id="first_name" class="form-control" type="text" value="<?php echo e(Auth::user()->name); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="user_email" class="col-lg-3 control-label">Email:</label>
                        <div class="col-lg-8">
                            <input id="user_email" class="form-control" type="text" value="<?php echo e(Auth::user()->email); ?>">
                        </div>
                    </div>
